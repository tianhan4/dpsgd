...
def run(noise_multiplier, l2_norm_clip, epochs, microbatch_size,batch_size = 500):
    ...
    for model_type in ["sphinx+mnist+tied_bias"]: #, "ALLnoise+mnist+tied_bias", "mnist+tied_bias+noise_input"]:
        ...
        accuracies[model_type].append(history.history)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--microbatch_size', type=int, default=10)
    args = parser.parse_args()
    run(args.noise_multiplier, args.l2_norm_clip, args.epochs, args.microbatch_size)